...
%% Main Program
% ----------------------------------------------------------------------
function Top99_120_60(nelx,nely,volfrac,penal,rmin)
...
% DEFINE LOADS AND SUPPORTS(HALF MBB-BEAM)
 ...
 F(7442,1) =-30;% Apply P1 at the buttom right corner of element(elx=60 ely=60)
 F(11102,1)=-15;% Apply P2 at the right buttom corner of element(elx=90 ely=60)    
