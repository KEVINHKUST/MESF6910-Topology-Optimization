...
%% Main Program
% ----------------------------------------------------------------------
function Top99_240_120(nelx,nely,volfrac,penal,rmin)
...
% START ITERATION
while change > 0.0001  % change = max(max(abs(x-xold))) in loop;
loop = loop + 1;
xold = x;
...
% DEFINE LOADS AND SUPPORTS(HALF MBB-BEAM)
 F(14762,1) =-15;% Apply P2 at the right buttom corner of element(elx=30 ely=60) 
 % 2*(nely+1)=122£»122 is the y direction of left buttom corner node in
 % global
 % 122*31=3782£»122*61=7442£»122*91=11102;
 F(29282,1) =-30;% Apply P1 at the buttom right corner of element(elx=60 ely=60)
 F(43802,1)=-15;% Apply P2 at the right buttom corner of element(elx=90 ely=60)    
 fixeddofs =[241 242 58322];% fixeddofs define the degrees of freedom that are fixed
